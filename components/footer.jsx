    ...
    <footer className="bg-background py-16 md:py-28 border-t border-muted">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="flex justify-center mb-8" data-aos="fade-up">
          <Link href="/" aria-label="go home" className="flex items-center justify-center">
            <Logo className="text-center h-10 w-auto" />
          </Link>
        </div>
        ...
        {/* Social Icons */}
        <div className="flex justify-center flex-wrap gap-5 mb-10" data-aos="fade-up" data-aos-delay="200">
          {socials.map((social, index) => (
            <Link key={index} href={social.href} target="_blank" rel="noopener noreferrer" aria-label={social.label} className="text-muted-foreground hover:text-primary transition">
