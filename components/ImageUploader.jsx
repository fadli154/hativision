  ...
  return (
    <>
      <button
        onClick={handleClick}
        tabIndex={0}
        className={`${className} p-5 rounded-lg backdrop-blur-lg border bg-transparent shadow-md hover:shadow-md hover:scale-105 focus:scale-105 active:scale-95 transition-all duration-300 ease-out cursor-pointer group relative overflow-hidden z-10 focus-visible:outline-none`}
      >
