...
export async function POST(req) {
  ...
  const text =
    ...
    "Maaf, AI tidak bisa membalas saat ini.";
  ...
  // Convert audio to base64 data URL for frontend
  const audioUrl = `data:audio/mpeg;base64,${Buffer.from(audioBuffer).toString(
    "base64"
  )}`;
